...
//       // 加载音乐文件夹信息
//       FileUtils.decodeJson(musicFoldersFile.readAsStringSync()).then((value) {
//         musicFolders = value.map((k, v) => MapEntry(k, List<String>.from(v)));
//       });
...
//             -1, 44100, 0, 0, 0.03, 0, nullptr, nullptr) ==
//         0) {
...
//       "currentPosition": 0,
//     };
//     await FileUtils.saveJson(settings, filePath);
//   }
...
//     // }
//     if (save) {
//       FileUtils.saveJson(settings, settings["settingsPath"]);
//       FileUtils.saveJson(musicFolders, '$currentDir\\puraMusicFolders.json');
//     }
//     //   更新musicFolders
...
//     String nextFilePath = getPathByIndex(nextIndex, musicList);
